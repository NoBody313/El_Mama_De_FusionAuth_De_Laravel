        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <div
                        class="scale-100 p-6 bg-white bg-gray-800/50 bg-gradient-to-bl from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 shadow-none">
                        ...
                        <pre id="profile" class="mt-4 text-gray-500 text-gray-400 text-sm">Retrieving user data...</pre>
                    </div>
                    ...
                    <div
                        ...
                        <pre id="api-results" class="mt-4 text-gray-500 text-gray-400 text-sm">Loading messages...</pre>
                    </div>
                </div>
                <div class="text-center mt-16">
                    <a href="{{ $logoutUrl }}" class="px-4 py-3 font-semibold bg-gray-100 rounded-full shadow-2xl">
                        Log out
                    </a>
                </div>
                @else
                <div class="text-center">
                    <a href="{{ $loginUrl }}" class="px-4 py-3 font-semibold bg-gray-100 rounded-full shadow-2xl">
